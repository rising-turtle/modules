...
std::string g_strLastestFile;
bool g_bLastestFileReady = false;
...
bool getLatestFileName(std::string& fname)
{
	if(!g_bLastestFileReady)
	{
		fname = g_strLastestFile;
		return false;
	}
	g_bLastestFileReady = false;
	fname = g_strLastestFile;
	return true;
}

void setLatestFileName(std::string& fname)
{
	g_strLastestFile = fname; 
	g_bLastestFileReady = true;
}
