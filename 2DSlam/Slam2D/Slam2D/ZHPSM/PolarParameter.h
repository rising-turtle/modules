...
public:
	_PM_SICK_LMS511():Base_PARAM("LMS511",361,180,5000,80,40,25.0){}
}PM_SICK_LMS511;

typedef struct _PM_SICK_LMS211 : public Base_PARAM{
public:
	_PM_SICK_LMS211():Base_PARAM("LMS211",181,180,5000,40,20,25.0){}
}PM_SICK_LMS211;

typedef struct _PM_SICK_LMS151 : public Base_PARAM{
public:
	_PM_SICK_LMS151():Base_PARAM("LMS151",541,270,5000,100,50,25.0){}
}PM_SICK_LMS151;
...
#ifdef VEC_OP
	_PMScan(int pts):r(pts),x(pts),y(pts),bad(pts),seg(pts){}
#endif
