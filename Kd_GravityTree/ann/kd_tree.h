...
public:
	...
	virtual void ann_search1(ANNdist) = 0;		// gravity search
...
class  ANNkd_leaf: public ANNkd_node		// leaf node for kd-tree
{
	...
	ANNpoint gravity_p; // the gravity point of all the points in the bucket
...
public:
	...
	virtual void ann_search1(ANNdist);			// gravity search
