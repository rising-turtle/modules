...
#include <cstring>			// JLBC: For strcmp
...
const ANNdist	ANN_DIST_INF = FLT_MAX; //ANN_DBL_MAX;
...
public:
	...
	/*reload annkSearch to approximately calculate nearest gravity_point*/
	void annkSearch1(
	...
	double				eps=0.0);			// the error bound
