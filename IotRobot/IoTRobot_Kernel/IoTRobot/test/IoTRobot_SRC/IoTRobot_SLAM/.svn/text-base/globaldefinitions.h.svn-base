...
extern const double global_graph_radius;
extern const int global_graph_size;
extern const int global_bg_graph_threshold;
extern const int global_max_translation_meter;
